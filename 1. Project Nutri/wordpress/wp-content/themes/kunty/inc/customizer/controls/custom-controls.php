<?php
/**
 * Kunty Customizer Custom Controls
 *
 */
...
if ( class_exists( 'WP_Customize_Control' ) ) {
	 ...
	 */
	class Kunty_Custom_Control extends WP_Customize_Control {
		protected function get_kunty_resource_url() {
	...
	if( ! class_exists( 'Kunty_Dropdown_Taxonomies_Control' ) ):
		class Kunty_Dropdown_Taxonomies_Control extends WP_Customize_Control{
			private $cats = false;
	 ...
	 * @link https://github.com/maddisondesigns
	 */
	class Kunty_Custom_Section extends WP_Customize_Section {
		protected function get_kunty_resource_url() {
			if( strpos( wp_normalize_path( __DIR__ ), wp_normalize_path( WP_PLUGIN_DIR ) ) === 0 ) {
				// We're in a plugin directory and need to determine the url accordingly.
				return plugin_dir_url( __DIR__ );
	 ...
	 * @link https://github.com/maddisondesigns
	 */
	 class Kunty_Image_Checkbox_Custom_Control extends Kunty_Custom_Control {
		/**
		...
		public function enqueue() {
			wp_enqueue_style( 'kunty-custom-controls-css', $this->get_kunty_resource_url() . 'assets/css/customizer.css', array(), '1.0', 'all' );
		}
		/**
	 ...
	 * @link https://github.com/maddisondesigns
	 */
	 class Kunty_Text_Radio_Button_Custom_Control extends Kunty_Custom_Control {
		/**
		 * The type of control being rendered
		 */
	 ...
	 * @link https://github.com/maddisondesigns
	 */
	class Kunty_Image_Radio_Button_Custom_Control extends Kunty_Custom_Control {
		/**
		 * The type of control being rendered
		 */
	 ...
	 * @link https://github.com/maddisondesigns
	 */
	class Kunty_Single_Accordion_Custom_Control extends Kunty_Custom_Control {
		/**
		 * The type of control being rendered
		 */
		 ...
		 */
		public function enqueue() {
			wp_enqueue_script( 'kunty-custom-controls-js', $this->get_kunty_resource_url() . 'assets/js/customizer.js', array( 'jquery' ), '1.0', true );
			wp_enqueue_style( 'kunty-custom-controls-css', $this->get_kunty_resource_url() . 'assets/css/customizer.css', array(), '1.0', 'all' );
		}
		/**
		 * Render the control in the customizer
	 ...
	 * @link https://github.com/maddisondesigns
	 */
	class Kunty_Simple_Notice_Custom_Control extends Kunty_Custom_Control {
		/**
		 * The type of control being rendered
		 */
	 ...
	 * @link https://github.com/maddisondesigns
	 */
	class Kunty_Slider_Custom_Control extends Kunty_Custom_Control {
		/**
		 * The type of control being rendered
		 */
		 ...
		 */
		public function enqueue() {
			wp_enqueue_script( 'kunty-custom-controls-js', $this->get_kunty_resource_url() . 'assets/js/customizer.js', array( 'jquery', 'jquery-ui-core' ), '1.0', true );
			wp_enqueue_style( 'kunty-custom-controls-css', $this->get_kunty_resource_url() . 'assets/css/customizer.css', array(), '1.0', 'all' );
		}
		/**
		 * Render the control in the customizer
	 ...
	 * @link https://github.com/maddisondesigns
	 */
	class Kunty_Toggle_Switch_Custom_control extends Kunty_Custom_Control {
		/**
		 * The type of control being rendered
		 */
	 ...
	 * @link https://github.com/maddisondesigns
	 */
	class Kunty_Sortable_Repeater_Custom_Control extends Kunty_Custom_Control {
		/**
		 * The type of control being rendered
		 */
	 ...
	 * @link https://github.com/maddisondesigns
	 */
	class Kunty_Dropdown_Posts_Custom_Control extends Kunty_Custom_Control {
		/**
		 * The type of control being rendered
		 */
	 ...
	 * @link https://github.com/maddisondesigns
	 */
	class Kunty_TinyMCE_Custom_control extends Kunty_Custom_Control {
		/**
		 * The type of control being rendered
		 */
		...
		public function to_json() {
			parent::to_json();
			$this->json['kuntytinymcetoolbar1'] = isset( $this->input_attrs['toolbar1'] ) ? esc_attr( $this->input_attrs['toolbar1'] ) : 'bold italic bullist numlist alignleft aligncenter alignright link';
			$this->json['kuntytinymcetoolbar2'] = isset( $this->input_attrs['toolbar2'] ) ? esc_attr( $this->input_attrs['toolbar2'] ) : '';
			$this->json['kuntymediabuttons'] = isset( $this->input_attrs['mediaButtons'] ) && ( $this->input_attrs['mediaButtons'] === true ) ? true : false;
		}
		/**
		 * Render the control in the customizer
		 */
	 ...
	 * @link https://github.com/maddisondesigns
	 */
	class Kunty_Google_Font_Select_Custom_Control extends Kunty_Custom_Control {
		/**
		 * The type of control being rendered
		 */
		...
		public function __construct($manager, $id, $args = array(), $options = array() ) {
			...
			$this->fontList = $this->kunty_getGoogleFonts( 'all' );
			// Decode the default json font value
			$this->fontValues = json_decode( $this->value() );
			// Find the index of our default font within our list of Google fonts
			$this->fontListIndex = $this->kunty_getFontIndex( $this->fontList, $this->fontValues->font );
		}
		/**
		 * Enqueue our scripts and styles
		 */
		public function enqueue() {
			wp_enqueue_script( 'kunty-select2-js', $this->get_kunty_resource_url() . 'assets/js/select2.full.min.js', array( 'jquery' ), '4.0.13', true );
			wp_enqueue_script( 'kunty-custom-controls-js', $this->get_kunty_resource_url() . 'assets/js/customizer.js', array( 'kunty-select2-js' ), '1.0', true );
			wp_enqueue_style( 'kunty-custom-controls-css', $this->get_kunty_resource_url() . 'assets/css/customizer.css', array(), '1.1', 'all' );
			wp_enqueue_style( 'kunty-select2-css', $this->get_kunty_resource_url() . 'assets/css/select2.min.css', array(), '4.0.13', 'all' );
		}
		/**
		...
		public function to_json() {
			parent::to_json();
			$this->json['kuntyfontslist'] = $this->fontList;
		}
		/**
		 * Render the control in the customizer
		 */
		public function render_content() {
			...
			if( !empty($this->fontList) ) {
				...
				<div class="google_fonts_select_control">
					...
					<div class="customize-control-description"><?php esc_html_e( 'Font Weight', 'kunty' ) ?></div>
		 ...
		 */
		public function kunty_getFontIndex( $haystack, $needle ) {
		 ...
		 */
		public function kunty_getGoogleFonts( $count = 30 ) {
			// Google Fonts json generated from https://www.googleapis.com/webfonts/v1/webfonts?sort=popularity&key=YOUR-API-KEY
			
			if(class_exists('Themereps_Helper') && th_fs()->can_use_premium_code() ){
				$fontFile = $this->get_kunty_resource_url() . 'controls/google-fonts-alphabetical.json';
			} else{ 
				$fontFile = $this->get_kunty_resource_url() . 'controls/default-google-fonts-alphabetical.json';
			}
			
			if ( $this->fontOrderBy === 'popular' ) {
				$fontFile = $this->get_kunty_resource_url() . 'controls/google-fonts-popularity.json';
			}
	 ...
	 */
	class Kunty_Customize_Alpha_Color_Control extends Kunty_Custom_Control {
		/**
		 * The type of control being rendered
		 */
		 ...
		 */
		public function enqueue() {
			wp_enqueue_script( 'kunty-custom-controls-js', $this->get_kunty_resource_url() . 'assets/js/customizer.js', array( 'jquery', 'wp-color-picker' ), '1.0', true );
			wp_enqueue_style( 'kunty-custom-controls-css', $this->get_kunty_resource_url() . 'assets/css/customizer.css', array( 'wp-color-picker' ), '1.0', 'all' );
		}
		/**
		 * Render the control in the customizer
		 */
	 ...
	 */
	class Kunty_Alpha_Color_Control extends Kunty_Custom_Control {
		/**
		 * The type of control being rendered
		 */
		...
		public function enqueue() {
			wp_enqueue_style( 'kunty-custom-controls-css', $this->get_kunty_resource_url() . 'assets/css/customizer.css', array(), '1.0', 'all' );
			wp_enqueue_script( 'wp-color-picker-alpha', $this->get_kunty_resource_url() . 'assets/js/wp-color-picker-alpha-min.js', array( 'wp-color-picker' ), '1.0', true );
		...
		?>
		  <div class="wpcolorpicker_alpha_color_control">
				...
				<?php if( !empty( $this->description ) ) { ?>
					<span class="customize-control-description"><?php echo esc_html( $this->description ); ?></span>
				<?php } ?>
				<input type="text" class="wpcolorpicker-alpha-color-picker" id="<?php echo esc_attr( $this->id ); ?>" name="<?php echo esc_attr( $this->id ); ?>" value="<?php echo esc_attr( $this->value() ); ?>" class="customize-control-colorpicker-alpha-color" <?php echo esc_attr($this->attributes); ?> <?php $this->link(); ?> />
			</div>
		<?php
		}
	}
	 ...
	 * @link https://github.com/maddisondesigns
	 */
	class Kunty_Pill_Checkbox_Custom_Control extends Kunty_Custom_Control {
		/**
		 * The type of control being rendered
		 */
		 ...
		 */
		public function enqueue() {
			wp_enqueue_script( 'kunty-custom-controls-js', $this->get_kunty_resource_url() . 'assets/js/customizer.js', array( 'jquery', 'jquery-ui-core' ), '1.1', true );
			wp_enqueue_style( 'kunty-custom-controls-css', $this->get_kunty_resource_url() . 'assets/css/customizer.css', array(), '1.0', 'all' );
		}
		/**
		 * Render the control in the customizer
	 ...
	 *
	 */
	class Kunty_Upsell_Section extends Kunty_Custom_Section {
		/**
		 * The type of control being rendered
		 */
		public $type = 'kunty-upsell';
		/**
		 * The Upsell URL
		 */
		public $url = '';
		...
		protected function render() {
			...
			?>
			<li id="accordion-section-<?php echo esc_attr( $this->id ); ?>" class="kunty_upsell_section accordion-section control-section control-section-<?php echo esc_attr( $this->id ); ?> cannot-expand">
	 ...
	 *
	 */
		class Kunty_Custom_Text extends WP_Customize_Control
		{
			/**
	 ...
	 *
	 */
	class Kunty_Misc_Control extends WP_Customize_Control {
	 ...
	 */
	if ( ! function_exists( 'kunty_url_sanitization' ) ) {
		function kunty_url_sanitization( $input ) {
	 ...
	 */
	if ( ! function_exists( 'kunty_switch_sanitization' ) ) {
		function kunty_switch_sanitization( $input ) {
			if (true === $input ) {
				return 1;
			} else {
				return 0;
	 ...
	 * @return integer	Sanitized value
	 */
	if ( ! function_exists( 'kunty_radio_sanitization' ) ) {
		function kunty_radio_sanitization( $input, $setting ) {
	 ...
	 */
	if ( ! function_exists( 'kunty_sanitize_integer' ) ) {
		function kunty_sanitize_integer( $input ) {
			return (int) $input;
		}
	}
	/**
	 ...
	 *
	 * @param  string		Input value to check
	 * @return float	Returned float value
	 */
	if ( ! function_exists( 'kunty_sanitize_float' ) ) {
		function kunty_sanitize_float( $input ) {
	 ...
	 * @return string	Sanitized input
	 */
	if ( ! function_exists( 'kunty_text_sanitization' ) ) {
		function kunty_text_sanitization( $input ) {
			if ( strpos( $input, ',' ) !== false) {
				$input = explode( ',', $input );
			}
			if( is_array( $input ) ) {
	 ...
	 */
	if ( ! function_exists( 'kunty_array_sanitization' ) ) {
		function kunty_array_sanitization( $input ) {
			if( is_array( $input ) ) {
				foreach ( $input as $key => $value ) {
					$input[$key] = sanitize_text_field( $value );
				}
	 ...
	 * @return string	Sanitized input
	 */
	if ( ! function_exists( 'kunty_hex_rgba_sanitization' ) ) {
		function kunty_hex_rgba_sanitization( $input, $setting ) {
			...
			if ( false === strpos( $input, 'rgb' ) ) {
				...
				if ( false === strpos( $input, 'rgba' ) ) {
					...
					$input = 'rgb(' . kunty_in_range( $red, 0, 255 ) . ',' . kunty_in_range( $green, 0, 255 ) . ',' . kunty_in_range( $blue, 0, 255 ) . ')';
				}
				else {
					// Sanitize as RGBa color
					$input = str_replace( ' ', '', $input );
					sscanf( $input, 'rgba(%d,%d,%d,%f)', $red, $green, $blue, $alpha );
					$input = 'rgba(' . kunty_in_range( $red, 0, 255 ) . ',' . kunty_in_range( $green, 0, 255 ) . ',' . kunty_in_range( $blue, 0, 255 ) . ',' . kunty_in_range( $alpha, 0, 1 ) . ')';
				}
			}
			return $input;
		}
	 ...
	 */
	if ( ! function_exists( 'kunty_in_range' ) ) {
		function kunty_in_range( $input, $min, $max ){
			if ( $input < $min ) {
				$input = $min;
			}
			if ( $input > $max ) {
	 ...
	 * @return string	Sanitized input
	 */
	if ( ! function_exists( 'kunty_google_font_sanitization' ) ) {
		function kunty_google_font_sanitization( $input ) {
	 ...
	 * @return string	Sanitized input
	 */
	if ( ! function_exists( 'kunty_date_time_sanitization' ) ) {
		function kunty_date_time_sanitization( $input, $setting ) {
	 ...
	 * @return string	Sanitized input
	 */
	if ( ! function_exists( 'kunty_range_sanitization' ) ) {
		function kunty_range_sanitization( $input, $setting ) {
			...
			return kunty_in_range( $number, $min, $max );
		}
	}

		// Number Float-val
	if ( ! function_exists( 'kunty_floatval_sanitization' ) ) {
		function kunty_floatval_sanitization($input)
		{
	...
	if ( ! function_exists( 'kunty_validate_duration' ) ) :
		/**
		 ...
		 */
		function kunty_validate_duration( $validity, $value ){
			$value = intval( $value );
			if ( empty( $value ) || ! is_numeric( $value ) ) {
				$validity->add( 'required', esc_html__( 'You must supply a valid number.', 'kunty' ) );
			} elseif ( $value < 1000 ) {
				$validity->add( 'min_slider', esc_html__( 'Minimum time of duration is 1000', 'kunty' ) );
			} elseif ( $value > 20000 ) {
				$validity->add( 'max_slider', esc_html__( 'Maximum time of duration is 20000', 'kunty' ) );
			}
			return $validity;
		}
	endif;
