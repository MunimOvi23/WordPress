<?php
/**
 * education center pro Repeater Customizer Setting.
 * 
...
if ( ! class_exists( 'Kunty_Control_Repeater_Setting' ) ) {

	/**
	 * Repeater Settings.
	 */
	class Kunty_Control_Repeater_Setting extends WP_Customize_Setting {
