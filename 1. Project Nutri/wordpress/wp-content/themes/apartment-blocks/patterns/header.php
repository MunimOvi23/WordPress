...
<p class="has-primary-color has-text-color">(+099)-123-45678</p>
<!-- /wp:paragraph --></div>
<!-- /wp:group --></div>
<!-- /wp:column -->
...
<!-- wp:paragraph {"textColor":"primary"} -->
<p class="has-primary-color has-text-color"><?php esc_html_e('example@example.com','apartment-blocks'); ?></p>
<!-- /wp:paragraph --></div>
<!-- /wp:group --></div>
<!-- /wp:column --></div>
<!-- /wp:columns --></div>
...
<!-- wp:column {"verticalAlignment":"center","width":"75%","style":{"spacing":{"padding":{"right":"0","left":"0","top":"0","bottom":"0"}}},"textColor":"base","className":"menublock"} -->
<div class="wp-block-column is-vertically-aligned-center menublock has-base-color has-text-color" style="padding-top:0;padding-right:0;padding-bottom:0;padding-left:0;flex-basis:75%"><!-- wp:navigation {"textColor":"heading","backgroundColor":"section-bg","layout":{"type":"flex","justifyContent":"right"},"style":{"typography":{"fontStyle":"normal","fontWeight":"400"}},"fontSize":"small"} -->
