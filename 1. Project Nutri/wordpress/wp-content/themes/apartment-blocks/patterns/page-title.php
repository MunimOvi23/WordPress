...
/**
 * Title: Page Title
 * Slug: apartment-blocks/page-title
 * Categories: apartment-blocks, page-title
 */
?>

<!-- wp:cover {"url":"<?php echo esc_url( get_template_directory_uri().'/images/inner-banner.png' ); ?>","id":6,"dimRatio":0,"minHeight":300} -->
