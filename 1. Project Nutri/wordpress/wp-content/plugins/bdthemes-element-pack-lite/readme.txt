...
= 5.4.4 [30th October 2023] =

* Added: Creative button reklo style Added
* Added: Item & image margin options control added in review card widget
* Fixed: Ajax Search dropdown styling Control & translated issue fixed in Search Widget
* Fixed: Read more spacing issue fixed in panel slider widget

= 5.4.3 [15th October 2023] =

* Added: Backdrop Filter support added for Container
* Added: Icon Box Shadow option added in fancy list widget
* Fixed: Navigation anchor tag seo issue fixed
* Fixed: Target Link issue fixed in Logo Grid widget (Thanks to Red Wolf)
* Fixed: Lightbox hover issue fixed in image expand widget
* Updated: Price list control improved
